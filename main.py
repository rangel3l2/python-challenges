...
for escola in escolas:
    try:
        ...
        colegio.nome_escola = navegador.find_element(By.CSS_SELECTOR, ".qrShPb").text
        colegio.endereco_escola = navegador.find_element(By.CSS_SELECTOR, ".LrzXr").text
        lista_escolas.append(colegio)
    except:
        print('Deu ruim')
